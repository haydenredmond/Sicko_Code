function [S_Quadterp,I_Quadterp,R_Quadterp] = Quadratic_Interpolation(Susceptible,Infected,Recovered)
    function [Interpolated_Data] = Interpolate(Pop_Type)
        ...
        for i = 2:length(Pop_Type) - 1        
            ...
            b2 = 
            Interpolated_Points(i-1) = Pop_Type(i-1) + b1 * (Precise_Time(i-1)-Rough_Time(i-1)) + b2 * ; 
        end            
